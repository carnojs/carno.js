...
```ts
import { Controller, Get, ProviderScope } from '@cheetah.js/core';
...
Cheetah.js supports standard HTTP methods via decorators:
...
### JSON Response
By default, if you return an object or array, Cheetah.js serializes it to JSON and sets `Content-Type: application/json`.
