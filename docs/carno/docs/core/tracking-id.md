...
Carno.js includes a built-in mechanism to track requests across your distributed system using a unique ID.
...
```ts
import { Controller, Get, Context } from '@carno.js/core';
