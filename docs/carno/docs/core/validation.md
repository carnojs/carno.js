...
Carno.js includes built-in validation using [class-validator](https://github.com/typestack/class-validator) and [class-transformer](https://github.com/typestack/class-transformer).
...
You can pass `ValidatorOptions` to the `Carno` constructor to configure the global validation behavior (e.g., stripping unknown properties).
