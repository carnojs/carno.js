...
Carno.js ORM uses a clever type trick to handle **circular dependencies** between entities without runtime overhead.
...
import { Ref, Entity, ManyToOne } from '@carno.js/orm';
